...
## Usage
Start `main.py` script in `/home/pi/Room/Props/PyProps/PygameProps/PygameAsyncioBlinkProps`:
...
```bash
$ ps aux | grep python | grep -v "grep python" | grep PygameAsyncioBlinkProps/main.py | awk '{print $2}' | xargs kill -9 && screen -d -m python3 /home/pi/Room/Props/PyProps/PygameProps/PygameAsyncioBlinkProps/main.py -s %BROKER%
```
